...
var StyledTextInput = /** @class */ (function (_super) {
    ...
    StyledTextInput.prototype.render = function () {
        ...
        return (React.createElement("div", { className: className },
            ...
            React.createElement(Input, { name: name, style: inputStyle, placeholder: placeholder, error: error, value: this.state.value, disabled: disabled, onChange: this.handleChange, type: type }),
