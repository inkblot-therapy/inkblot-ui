...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.prototype.deselectOption = function (event) {
    ...
    Dropdown.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(StyledDropdown_1.default, { label: label, placeholder: placeholder, open: open, options: options, selected: selected, inlineMessage: inlineMessage, error: error, openDropdown: this.openDropdown, closeDropdown: this.closeDropdown, selectOption: this.selectOption, deselectOption: this.deselectOption })));
    };
    // Remove any objects that are in defaultValue from options
    Dropdown.prototype.removeDefaultValues = function (options, defaultValue) {
    ...
    Dropdown.prototype.changeOptions = function (event, deselect) {
        var _this = this;
    ...
    Dropdown.prototype.updateFormValue = function () {
