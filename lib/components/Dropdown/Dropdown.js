...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.prototype.render = function () {
        var _a = this.props, name = _a.name, label = _a.label, inlineMessage = _a.inlineMessage, error = _a.error;
        var _b = this.state, open = _b.open, options = _b.options, selected = _b.selected, formValue = _b.formValue;
        return (React.createElement("div", null,
            React.createElement("input", __assign({}, this.props, { style: { display: 'none' }, name: name, value: formValue, readOnly: true })),
