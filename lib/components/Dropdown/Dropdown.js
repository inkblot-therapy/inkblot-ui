...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.prototype.render = function () {
        var _a = this.props, label = _a.label, inlineMessage = _a.inlineMessage, error = _a.error, input = _a.input;
        var _b = this.state, open = _b.open, options = _b.options, selected = _b.selected;
        return (React.createElement("div", null,
            React.createElement("input", __assign({}, input, { style: { display: 'none' } })),
