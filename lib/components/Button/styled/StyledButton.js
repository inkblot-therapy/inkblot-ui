...
var Button = styled_components_1.default('button')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  border-radius: 20px;\n  cursor: ", ";\n  height: 40px;\n  padding: 0 40px;\n  font-family: ", "\n  font-size: ", ";\n  font-weight: 600;\n  letter-spacing: 0.5px;\n  outline: none;\n  &:focus {\n    outline: none;\n  }\n  color: ", ";\n  background-color: ", ";\n  background-image: ", ";\n  border: none;\n  box-shadow: ", ";\n"], ["\n  border-radius: 20px;\n  cursor: ", ";\n  height: 40px;\n  padding: 0 40px;\n  font-family: ", "\n  font-size: ", ";\n  font-weight: 600;\n  letter-spacing: 0.5px;\n  outline: none;\n  &:focus {\n    outline: none;\n  }\n  color: ",
    ...
    return (!people ? '"Barlow", sans-serif;' : '"Montserrat", sans-serif;');
}, function (_a) {
    var people = _a.people;
    return (!people ? '16px' : '12px');
}, function (_a) {
    var disabled = _a.disabled, primary = _a.primary, secondary = _a.secondary, tertiary = _a.tertiary, people = _a.people, theme = _a.theme;
    if (disabled) {
    ...
    var primary = _a.primary, secondary = _a.secondary, people = _a.people, theme = _a.theme;
    if (primary) {
