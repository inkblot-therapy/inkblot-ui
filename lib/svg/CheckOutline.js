...
var SvgCheckOutline = function (props) { return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "46", height: "46", viewBox: "0 0 46 46" },
    React.createElement("defs", null,
        ...
        React.createElement("filter", { id: "a", width: "215.4%", height: "215.4%", x: "-57.7%", y: "-57.7%", filterUnits: "objectBoundingBox" },
            ...
            React.createElement("feColorMatrix", { in: "shadowBlurOuter1", values: "0 0 0 0 0.388235294 0 0 0 0 0.549019608 0 0 0 0 0.694117647 0 0 0 0.1 0" }))),
    React.createElement("g", { fill: "none", "fill-rule": "evenodd", transform: "translate(10 10)" },
        React.createElement("use", { fill: "#000", filter: "url(#a)" }),
        React.createElement("rect", { width: "24", height: "24", x: "1", y: "1", fill: "#FFF", stroke: "#2E5FCA", strokeOpacity: ".2", strokeWidth: "2", rx: "4" })))); };
