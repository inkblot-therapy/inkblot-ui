...
const buttonBgColors = Object.keys(theme.button.backgroundColor).map((key) => (
  <Color name={key} color={theme.button.backgroundColor[key]} />
));
...
stories.add('button.backgroundColor', () => (
  <React.Fragment>{buttonBgColors}</React.Fragment>
));
